...
back = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab10\\snake_up\\snake_fon.jpg")
...
food = p.image.load("C:\\Users\Рахат\\Desktop\\PP2-2025\\lab10\\snake_up\\apple.png")
...
# Setting up buttons
qquit = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab10\\snake_up\\quit.png")
qquit = p.transform.scale(qquit, (125, 102))
restart = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab10\\snake_up\\restart.png")
    ...
    if start_screen:
        ...
        if not collision and not pause:
            ...
            if (
                ...
                collision = True
                if not hit_sound:
                    p.mixer.Sound("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab10\\snake_up\\hit.mp3").play()
                    hit_sound = True
                    cursor.execute(
                        "INSERT INTO snake_scores (player_name, score) VALUES (%s, %s)",
                        (player_name, score)
            ...
            if (
                ...
                p.mixer.Sound("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab10\\snake_up\\sound_apple.mp3").play()
                food_spawn_time = time.time()
                if food == food_size1:
                    score += 3
                ...
                if level - prev_level >= 1:
                    p.mixer.Sound("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab10\\snake_up\\level_up.mp3").play()
                    prev_level = level
            else:
                snake_body.pop()
