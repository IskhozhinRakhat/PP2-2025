...
back = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\snake\\snake_fon.jpg")
...
food = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\snake\\apple.png")
...
#Setting up buttons
qquit = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\snake\\quit.png")
qquit = p.transform.scale(qquit, (125,102))
restart = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\snake\\restart.png")
...
while run:
    for i in p.event.get():
        ...
        if i.type == p.MOUSEBUTTONDOWN and collision:
            ...
            if restart_rect.collidepoint(mouse_pos):
                p.mixer.Sound("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\snake\\snake_mouse_click.mp3").play()
                time.sleep(0.5)
                score = 0
                SPEED = 5
                level = 1
    ...
    if snake_head[0] <= 0 or snake_head[0] >= X or snake_head[1] <= 0 or snake_head[1] >= Y:
        collision = True
        if not hit_sound:
            p.mixer.Sound("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\snake\\snake_hit.mp3").play()
            hit_sound = True
    ...
    if snake_head[0] >= food_pos[0] - 15 and snake_head[0] <= food_pos[0] + 25:
        if snake_head[1] >= food_pos[1] - 15 and snake_head[1] <= food_pos[1] + 25:
            p.mixer.Sound("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\snake\\snake_sound_apple.mp3").play()
            food_spawn_time = time.time()
            if food == food_size1:
                score += 3
            ...
            if level - prev_level >= 1:
                p.mixer.Sound("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\snake\\snake_level_up.mp3").play()
                prev_level = level
        else:
            snake_body.pop()
    else:
