...
p.mixer.music.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\racer\\racer_back_music.wav")
...
back = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\racer\\fon.png")
back = p.transform.scale(back, (X,Y))

#Import images of buttons
restart = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\racer\\restart.png")
qquit = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\racer\\quit.png")
...
class Enemy(p.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\racer\\Enemy.png")
...
class Player(p.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\racer\\Player.png")
        self.rect = self.image.get_rect()
...
class Coin(p.sprite.Sprite):
    def __init__(self):
        ...
        self.image = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\racer\\coin.png")
...
image_of_coin = p.image.load("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\racer\\coin.png")
...
while run:
    for i in p.event.get():
        ...
        if i.type == p.MOUSEBUTTONDOWN and game_over_state:
            ...
            p.mixer.Sound("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\racer\\racer_mouse_click.mp3").play()
    ...
    if p.sprite.spritecollideany(P1, enemies) and not game_over_state:
        p.mixer.Sound("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\racer\\racer_crash.wav").play()
        time.sleep(0.5)
    ...
    if p.sprite.spritecollideany(P1, coins) and not game_over_state:
        ...
        p.mixer.Sound("C:\\Users\\Рахат\\Desktop\\PP2-2025\\lab9\\racer\\racer_collect.mp3").play()
        C1.reset()
        p.display.update()
